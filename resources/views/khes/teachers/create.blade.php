      ...
      <div class="col-md-9">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form method="POST" action="{{ url('/khes/teachers') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  @include ('khes.teachers.form', ['formMode' => 'create'])
               </form>
            </div>
         </div>
      </div>
